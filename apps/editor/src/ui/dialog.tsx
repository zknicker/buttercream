...
export const dialogBackdropClass = classes(
  "fixed inset-0 z-20 bg-ink/35 backdrop-blur-[2px] transition-opacity duration-150",
...
export const dialogPanelClass = classes(
  "flex max-h-[min(46rem,calc(100dvh-3rem))] flex-col gap-4 overflow-hidden rounded-xl bg-parchment p-6",
  "shadow-2xl shadow-ink/25 ring-1 ring-ink/10 outline-none",
...
export const dialogTitleClass = "font-display text-xl text-ink";
export const dialogDescriptionClass = "mt-1.5 text-base text-pretty text-graphite sm:text-sm";
